...
def add_note_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    ipm_2_5__result = phantom.collect2(container=container, datapath=["ipm_2_5:custom_function_result.data.severity"])

    parameters = []

    # build parameters list for 'add_note_1' call
    for ipm_2_5__result_item in ipm_2_5__result:
        parameters.append({
            "title": "title3",
            "content": ipm_2_5__result_item[0],
